...
# --- Graph definition ---
prod = wf.Node("prod", start_proc=0, nprocs=2, func='prod', cmdline='python3 ./worker.py --epochs 1 --ex_rate 1 --cuda 0') #epoch exchange_rate (for first_iter)
inPort = prod.addInputPort("in")
inPort.setTokens(1)
outPort = prod.addOutputPort("out")

con = wf.Node("con", start_proc=2, nprocs=1, func='con', cmdline='python3 ./master.py 256 1 2000') #total_trials exchange_rate cp_freq
